...
##################################################################################x
def totalOb():
    totalOB = zoneAA.get() + zoneAC.get() + zoneAI.get() + zoneBA.get() + zoneBC.get() +zoneBI.get() + zoneCA.get() + zoneCC.get() + zoneCI.get()
    totalOB_label = Label(root, text=totalOB)
    totalOB_label.grid(row=13, column =1)
...
total_button = Button(root, text="SHOW TOTAL",command=totalOb)
...
horizontalSpace = Label(root)
verticalSpace1 = Label(root)
...
total_button.grid(row=13, column=0, sticky=W)
